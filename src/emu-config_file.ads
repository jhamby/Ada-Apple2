...
--  Package for getting config file paths.

package Emu.Config_File with
  SPARK_Mode
is

   function Get_Config_File_Name (App_Name : String) return String;
   --  Look up the config file pathname to use
